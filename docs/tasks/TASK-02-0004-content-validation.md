...
Apply the repository and validation rules to the complete curated `assets/articles.csv` snapshot and its declared bundled media. Do not create a standalone pre-Flutter validation tool.

## Completion criteria

- A repeatable check loads all 127 curated CSV records through the repository and validation path.
...
Blocked by TASK-02-0002 and TASK-02-0003. TASK-00-0001 established the current snapshot's integrity; this task adds repeatable validation beside the app's CSV loader and unit tests.
