...
Task 0.1 established that every row resolves to its declared local image, noun-audio, and answer-audio files. CSV paths remain unchanged.

## Decisions and blockers

All retained article media is approved by task 0.2. Repeatable validation for
