...
The managed runner also installs a pinned Docker Compose CLI plugin and verifies its checksum before Maven reaches the Compose-backed verification environment steps.
